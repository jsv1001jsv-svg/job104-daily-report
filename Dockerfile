...
# 註：這裡曾經要裝 Chromium（約 1GB）來繞過 Cloudflare。
# 2026-08-02 查明 Cloudflare 是靠 TLS 指紋辨識機器人，改用 curl_cffi
# 在純 Python 裡模仿瀏覽器的 handshake 即可，瀏覽器整層已移除。
# 完整脈絡見 CLAUDE.md 第 5.1 節。
